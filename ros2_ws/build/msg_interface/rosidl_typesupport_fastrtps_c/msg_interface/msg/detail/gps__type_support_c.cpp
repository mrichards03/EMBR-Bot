...
#include "msg_interface/msg/detail/gps__rosidl_typesupport_fastrtps_c.h"
...
using _Gps__ros_msg_type = msg_interface__msg__Gps;
...
static uint32_t _Gps__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_interface__msg__Gps(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_interface__msg__Gps;
    is_plain =
      (
...
static size_t _Gps__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_interface__msg__Gps(
