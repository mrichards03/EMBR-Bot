...
bool msg_interface__msg__gps__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_interface.msg._gps.Gps", full_classname_dest, 26) == 0);
  }
  msg_interface__msg__Gps * ros_message = _ros_message;
  {  // lat
...
PyObject * msg_interface__msg__gps__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_interface.msg._gps");
